...
import 'package:internship_5to9_1/screens/job_description_screen.dart';
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () async {
                        if (FavouriteController.instance
                            .isFavourite(widget.job.id)) {
                          await FavouriteController.instance
